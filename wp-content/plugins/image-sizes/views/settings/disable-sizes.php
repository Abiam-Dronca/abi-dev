			...
			<div class="image_sizes-enable-thumbnails">
				...
				<ul id="sortable1" class="image_sizes-sortable enable">
					<li class="image_sizes-original-size">
						...
						<span><img class="image_sizes-thumbnails-arrow-right" src="<?php echo esc_url( plugins_url( 'assets/img/arrow.png', THUMBPRESS ) ); ?>"></span>
					</li>
					<?php foreach ( $image_sizes as $id => $size ):
						if ( ! in_array( $id, $image_sizes_disables ) ) {
							...
							echo '<li class="ui-state-default draggable-item">
								<span class="image_sizes-thumbnails-name"> <img class="image_sizes-thumbnails-arrow-left" src="'. esc_url( plugins_url( 'assets/img/arrow.png', THUMBPRESS ) ) .'">'. esc_html( $id ) .'</span> 
		...
		<div class="image_sizes-default-thumbnails">
			<div class="image_sizes-enable-thumbnails">
				...
				<ul id="sortable1" class="image_sizes-sortable">
					<li class="ui-state-default draggable-item">Item 1 <img src="<?php echo esc_url( plugins_url( 'assets/img/arrow.png', THUMBPRESS ) ); ?>"></span></li>
					<li class="ui-state-default draggable-item">Item 2 <img src="<?php echo esc_url( plugins_url( 'assets/img/arrow.png', THUMBPRESS ) ); ?>"></span></li>
					<li class="ui-state-default draggable-item">Item 3 <img src="<?php echo esc_url( plugins_url( 'assets/img/arrow.png', THUMBPRESS ) ); ?>"></span></li>
					<li class="ui-state-default draggable-item">Item 4 <img src="<?php echo esc_url( plugins_url( 'assets/img/arrow.png', THUMBPRESS ) ); ?>"></span></li>
					<li class="ui-state-default draggable-item">Item 5 <img src="<?php echo esc_url( plugins_url( 'assets/img/arrow.png', THUMBPRESS ) ); ?>"></span></li>
				</ul>
			</div>
			...
			<div class="image_sizes-disable-thumbnails">
				...
				<ul id="sortable2" class="image_sizes-sortable disable">
					<li class="ui-state-highlight sortable-item">Item 1 <img src="<?php echo esc_url( plugins_url( 'assets/img/arrow.png', THUMBPRESS ) ); ?>"></span></li>
					<li class="ui-state-highlight sortable-item">Item 2 <img src="<?php echo esc_url( plugins_url( 'assets/img/arrow.png', THUMBPRESS ) ); ?>"></span></li>
					<li class="ui-state-highlight sortable-item">Item 3 <img src="<?php echo esc_url( plugins_url( 'assets/img/arrow.png', THUMBPRESS ) ); ?>"></span></li>
					<li class="ui-state-highlight sortable-item">Item 4 <img src="<?php echo esc_url( plugins_url( 'assets/img/arrow.png', THUMBPRESS ) ); ?>"></span></li>
					<li class="ui-state-highlight sortable-item">Item 5 <img src="<?php echo esc_url( plugins_url( 'assets/img/arrow.png', THUMBPRESS ) ); ?>"></span></li>
				</ul>
			</div>
		</div>
	</div> -->
